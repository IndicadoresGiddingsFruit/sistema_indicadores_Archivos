    ...
    */
    var DayTableMixin = FC.DayTableMixin = {
        ...
        renderBgCellHtml: function (date, otherAttrs) {
            ...
            return '<td onmouseout="salioMouseCssCollapse(' + date.format("YYYYMMDD") + ');"' +
                ' onmouseover="entroMouseCssVisible(' + date.format("YYYYMMDD") + ');" ' +
                'class="' + classes.join(' ') + '"' +
    ...
    var DayGrid = FC.DayGrid = Grid.extend(DayTableMixin, {
        ...
        renderNumberCellHtml: function (date) {
            ...
            var dia = new Date(date).setHours(24, 0, 0, 0);

            return '' +
                '<td id="' + date.format('YYYYMMDD') + '" onmouseout=salioMouseCssCollapse(this.id); onmouseover=entroMouseCssVisible(this.id) class="'
                + classes.join(' ') + '" data-date="' + date.format() + '">' +
                    (hoy <= dia ?
                    "<button class='btn btn-link' data-toggle='modal' data-target='#ModalAgregar' id='" +
                        date.format('YYYYMMDD') + "'" +
                        " title='Agregar' style='visibility:collapse;' onclick='fecha(" + date + ")'>" +
